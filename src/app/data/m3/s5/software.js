...
export default [
    {
        ...
        cards: [
            ...
            { label: 'Composition', status: 'dropped' },
            { label: 'Gestion des brouillons', status: 'dropped' },
    ...
    },
    {
        label: 'Desktop OSX',
        cards: [
            { label: 'Détection des changements en local', status: 'done' },
